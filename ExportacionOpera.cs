...
namespace RotoTools
{
    public partial class ExportacionOpera : Form
    {
        ...
        #region CONSTRUCTORS
        public ExportacionOpera()
        {
            InitializeComponent();
        }
        public ExportacionOpera(XmlData exportDataXml)
        {
            InitializeComponent();
        ...
        private void ExportacionOpera_Load(object sender, EventArgs e)
        {
        ...
        private void btn_ExportSets_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Exportación a Opera completada.");
                }
                else
                {
